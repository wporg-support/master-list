# READ THIS FIRST - WordPress 4.1 Master List

Hooray! [Dinah is here](https://wordpress.org/news/2014/12/wordpress-4-1-dinah/)! But OMGWTFBBQ!? WordPress 4.1 broke everything?

_**Don’t Panic!**_

This thread contains the known issues with plugins and themes found in 4.1. Please read this WHOLE topic and come back and check again later, as it will be updated.
...
- **Do** use descriptive subject lines. “All permalinks broken since 4.1” is much better than “Augh! Help ASAP! This version is terrible!”
...
Make sure you’ve read the entire [Master List](https://wordpress.org/support/topic/read-this-first-wordpress-41-master-list) post – and the [New Features in 4.1 Codex Article](http://codex.wordpress.org/Version_4.1#What.27s_New) – http://codex.wordpress.org/Version_4.1
